# AWS Transfer Family identity\-based policy examples<a name="security_iam_id-based-policy-examples"></a>
...
## Using the AWS Transfer Family console<a name="security_iam_id-based-policy-examples-console"></a>
