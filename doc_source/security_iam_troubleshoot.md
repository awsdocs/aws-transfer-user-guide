# Troubleshooting AWS Transfer Family identity and access<a name="security_iam_troubleshoot"></a>
...
+ [I'm an administrator and want to allow others to access AWS Transfer Family](#security_iam_troubleshoot-admin-delegate)
...
## I am not authorized to perform an action in AWS Transfer Family<a name="security_iam_troubleshoot-no-permissions"></a>
...
## I'm an administrator and want to allow others to access AWS Transfer Family<a name="security_iam_troubleshoot-admin-delegate"></a>
...
## I want to allow people outside of my AWS account to access my AWS Transfer Family resources<a name="security_iam_troubleshoot-cross-account-access"></a>
